...
def parse_args_eposide_train():
    ...
    parser.add_argument('--lamba3', type=float, default=0.5, help='lamba_intra_local') 
    parser.add_argument('--lamba2', type=float, default=0.15, help='lamba_cross')
    parser.add_argument('--lamba1', type=float, default=1.0, help='lamba_intra') 
